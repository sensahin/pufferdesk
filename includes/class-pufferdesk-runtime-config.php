	...
	private function get_settings_labels_config( $theme = array() ) {
		...
		$labels = array(
			...
			'personalization' => array(
				'backgroundTitle'           => __( 'Background', 'pufferdesk-admin-desktop' ),
				'backgroundDescription'     => __( 'Background image, color, slideshow', 'pufferdesk-admin-desktop' ),
				'colorsTitle'               => __( 'Colors', 'pufferdesk-admin-desktop' ),
	...
	private function get_menu_config( $theme = array() ) {
		...
		$config = array(
			...
			'labels'     => array(
				...
				'search_group_app_route'  => __( 'App Sections', 'pufferdesk-admin-desktop' ),
				...
				'search_type_app_route'   => __( 'App Section', 'pufferdesk-admin-desktop' ),
				...
				'app_unavailable'         => __( 'App unavailable.', 'pufferdesk-admin-desktop' ),
					...
					'uninstall'               => __( 'Uninstall', 'pufferdesk-admin-desktop' ),
