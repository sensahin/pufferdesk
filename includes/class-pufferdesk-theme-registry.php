...
final class PufferDesk_Theme_Registry {
	...
	public function get_themes() {
		$themes = array(
			...
			'cupertino' => array(
				'id'             => 'cupertino',
				'label'          => __( 'Cupertino', 'pufferdesk' ),
				'family'         => 'cupertino',
				'family_label'   => __( 'Cupertino', 'pufferdesk' ),
				'version'        => 'default',
				'version_label'  => __( 'Default', 'pufferdesk' ),
				'parent'         => 'pufferdesk-base',
				...
				'tokens'         => array(
					...
					'labels'                   => array(
						...
						'desktop_launcher'     => __( 'Desktop & Dock', 'pufferdesk' ),
						'launcher_and_desktop' => __( 'Dock & Desktop', 'pufferdesk' ),
						'launcher_position'    => __( 'Dock position on screen', 'pufferdesk' ),
						'auto_hide_launcher'   => __( 'Automatically hide and show the Dock', 'pufferdesk' ),
						'launcher_options'     => __( 'Options', 'pufferdesk' ),
						'keep_in_launcher'     => __( 'Keep in Dock', 'pufferdesk' ),
						'remove_from_launcher' => __( 'Remove from Dock', 'pufferdesk' ),
						'open_at_login'        => __( 'Open at Login', 'pufferdesk' ),
						'minimize_animation_genie' => __( 'Sweep Effect', 'pufferdesk' ),
						'minimize_animation_scale' => __( 'Scale Effect', 'pufferdesk' ),
						'menu_bar'             => __( 'Menu Bar', 'pufferdesk' ),
						'menu_bar_background'  => __( 'Show menu bar background', 'pufferdesk' ),
					),
				),
				'menu'           => array(
					'labels' => array(
						'get_info' => __( 'Get Info', 'pufferdesk' ),
					),
				),
				'info_panel'     => array(
					'labels' => array(
						'accessLabel'               => __( 'Access', 'pufferdesk' ),
						'createdLabel'              => __( 'Created', 'pufferdesk' ),
						/* translators: %s: item name. */
						'documentInfoTitle'         => __( '%s Info', 'pufferdesk' ),
						/* translators: %s: folder name. */
						'folderInfoTitle'           => __( '%s Info', 'pufferdesk' ),
						'generalSection'            => __( 'General:', 'pufferdesk' ),
						'infoFallbackTitle'         => __( 'Info', 'pufferdesk' ),
						'kindLabel'                 => __( 'Kind', 'pufferdesk' ),
						'modifiedLabel'             => __( 'Modified', 'pufferdesk' ),
						/* translators: %s: formatted modified date. */
						'modifiedTemplate'          => __( 'Modified: %s', 'pufferdesk' ),
						'moreInfoLabel'             => __( 'More Info...', 'pufferdesk' ),
						'moreInfoSection'           => __( 'More Info:', 'pufferdesk' ),
						'nameSection'               => __( 'Name:', 'pufferdesk' ),
						'previewSection'            => __( 'Preview:', 'pufferdesk' ),
						'privateUserAccess'         => __( 'Private to this WordPress user', 'pufferdesk' ),
						'sharingPermissionsSection' => __( 'Sharing & Permissions:', 'pufferdesk' ),
						'siteHealthInfoTitle'       => __( 'Site Health Info', 'pufferdesk' ),
						'typeLabel'                 => __( 'Type', 'pufferdesk' ),
						'whereLabel'                => __( 'Where', 'pufferdesk' ),
					),
				),
			...
			'redmond' => array(
				'id'             => 'redmond',
				'label'          => __( 'Redmond', 'pufferdesk' ),
				'family'         => 'redmond',
				'family_label'   => __( 'Redmond', 'pufferdesk' ),
				'version'        => 'default',
				'version_label'  => __( 'Default', 'pufferdesk' ),
				'parent'         => 'pufferdesk-base',
				...
				'app_labels'     => array(
					'trash' => __( 'Recycle Bin', 'pufferdesk' ),
				),
				'menu'           => array(
					'labels' => array(
						'trash'                   => __( 'Recycle Bin', 'pufferdesk' ),
						...
						'trash_item_count'        => __( 'Recycle Bin, %d item', 'pufferdesk' ),
						/* translators: %d: number of items in the Recycle Bin. */
						'trash_item_count_plural' => __( 'Recycle Bin, %d items', 'pufferdesk' ),
						'empty_trash'             => __( 'Empty Recycle Bin', 'pufferdesk' ),
						'empty_trash_title'       => __( 'Empty Recycle Bin?', 'pufferdesk' ),
						'pufferdesk_trash_source' => __( 'PufferDesk Recycle Bin', 'pufferdesk' ),
						'move_folder_to_trash_window_title' => __( 'Delete Folder', 'pufferdesk' ),
						'move_folder_to_trash_confirmation' => __( 'Are you sure you want to move this folder to the Recycle Bin?', 'pufferdesk' ),
						'move_folder_to_trash_confirm_label' => __( 'Yes', 'pufferdesk' ),
						'move_folder_to_trash_cancel_label' => __( 'No', 'pufferdesk' ),
						'move_folders_to_trash_window_title' => __( 'Delete Folders', 'pufferdesk' ),
						'move_folders_to_trash_confirmation' => __( 'Are you sure you want to move these folders to the Recycle Bin?', 'pufferdesk' ),
						'move_folders_to_trash_confirm_label' => __( 'Yes', 'pufferdesk' ),
						/* translators: %d: number of selected folders. */
						'move_folders_to_trash_title_format' => __( 'Move %d folders to the Recycle Bin?', 'pufferdesk' ),
					),
				),
				'dialogs'        => array(
					'style'         => 'system-window',
				...
				'shell'          => array(
					...
					'labels'              => array(
						'launcher'             => __( 'Taskbar', 'pufferdesk' ),
						'desktop_launcher'     => __( 'Desktop & Taskbar', 'pufferdesk' ),
						'launcher_and_desktop' => __( 'Taskbar & Desktop', 'pufferdesk' ),
						'launcher_position'    => __( 'Taskbar position on screen', 'pufferdesk' ),
						'auto_hide_launcher'   => __( 'Automatically hide the taskbar', 'pufferdesk' ),
						'launcher_options'     => __( 'Taskbar Options', 'pufferdesk' ),
						...
						'keep_in_launcher'     => __( 'Pin to taskbar', 'pufferdesk' ),
						'remove_from_launcher' => __( 'Unpin from taskbar', 'pufferdesk' ),
						'open_at_login'        => __( 'Open at sign-in', 'pufferdesk' ),
						'minimize_animation_genie' => __( 'Sweep', 'pufferdesk' ),
						'minimize_animation_scale' => __( 'Scale', 'pufferdesk' ),
						'menu_bar'             => __( 'Top bar', 'pufferdesk' ),
						'menu_bar_background'  => __( 'Show top bar background', 'pufferdesk' ),
					),
				...
				'settings'       => array(
					'labels' => array(
						...
						'sidebar'      => array(
							'searchPlaceholder' => __( 'Find a setting', 'pufferdesk' ),
							'searchLabel'       => __( 'Find a setting', 'pufferdesk' ),
							'items'             => array(
								array(
									'id'    => 'general',
									'label' => __( 'Home', 'pufferdesk' ),
									'icon'  => 'dashicons-admin-home',
									'tone'  => 'orange',
								),
								array(
									'id'    => 'desktop-dock',
									'label' => __( 'System', 'pufferdesk' ),
								...
								array(
									'id'    => 'appearance',
									'label' => __( 'Personalization', 'pufferdesk' ),
									'icon'  => 'dashicons-admin-appearance',
									'tone'  => 'orange',
								),
								array(
									'id'    => 'profile',
									'label' => __( 'Accounts', 'pufferdesk' ),
						...
						'profile'      => array(
							'sectionLabel' => __( 'Accounts', 'pufferdesk' ),
						),
						'generalPanel' => array(
							'title'       => __( 'Home', 'pufferdesk' ),
							'description' => '',
						),
						'appearance'   => array(
							'title'         => __( 'Personalization', 'pufferdesk' ),
							'themeHeading'  => __( 'Themes', 'pufferdesk' ),
							'materialLabel' => __( 'Transparency effects', 'pufferdesk' ),
						),
						'desktopDock'  => array(
							'headings' => array(
								'dock'    => __( 'Taskbar', 'pufferdesk' ),
								'apps'    => __( 'Installed apps', 'pufferdesk' ),
