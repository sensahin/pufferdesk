...
final class PufferDesk_Assets {
	...
	public function enqueue( $hook ) {
		...
		foreach ( $theme['stylesheet_stack'] as $index => $stylesheet ) {
			...
			$style_handle = 'pufferdesk-theme-' . $theme['id'] . '-' . (int) $index;
			wp_enqueue_style(
				$style_handle,
		...
		wp_add_inline_script(
			$config_handle,
			'window.pufferDesk = ' . wp_json_encode( $this->get_runtime_config( $apps, $folders, $widgets, $theme, $app_locations ) ) . ';',
			'before'
		);
	}
	...
	private function should_use_dist_assets() {
		...
		return file_exists( PUFFERDESK_DIR . 'assets/dist/css/pufferdesk-core.min.css' )
			&& file_exists( PUFFERDESK_DIR . 'assets/dist/js/pufferdesk-admin-desktop.min.js' );
	}
	...
	private function enqueue_dist_core_styles( $include_shell ) {
		if ( ! $include_shell ) {
			wp_enqueue_style(
				'pufferdesk-core-admin-chrome',
				PUFFERDESK_URL . 'assets/css/core/admin-chrome.css',
				array( 'dashicons' ),
				$this->get_asset_version( 'assets/css/core/admin-chrome.css' )
			);

			return 'pufferdesk-core-admin-chrome';
		}

		wp_enqueue_style(
			'pufferdesk-core',
			PUFFERDESK_URL . 'assets/dist/css/pufferdesk-core.min.css',
			array( 'dashicons' ),
			$this->get_asset_version( 'assets/dist/css/pufferdesk-core.min.css' )
		);
	...
	private function enqueue_dist_script() {
		wp_enqueue_script(
			'pufferdesk-app',
			PUFFERDESK_URL . 'assets/dist/js/pufferdesk-admin-desktop.min.js',
			array(),
			$this->get_asset_version( 'assets/dist/js/pufferdesk-admin-desktop.min.js' ),
			true
		);
	...
	private function enqueue_core_scripts() {
		$scripts = array(
			'pufferdesk-config'         => array(
				'path' => 'assets/js/core/config.js',
				'deps' => array(),
			),
			'pufferdesk-dom'            => array(
				'path' => 'assets/js/core/dom.js',
				'deps' => array( 'pufferdesk-config' ),
			),
			'pufferdesk-storage'        => array(
				'path' => 'assets/js/core/services/storage.js',
				'deps' => array( 'pufferdesk-config' ),
			),
			'pufferdesk-api-client'     => array(
				'path' => 'assets/js/core/services/api-client.js',
				'deps' => array( 'pufferdesk-config' ),
			),
			'pufferdesk-session-store'  => array(
				'path' => 'assets/js/core/session/session-store.js',
				'deps' => array( 'pufferdesk-storage', 'pufferdesk-api-client' ),
			),
			'pufferdesk-reopen-policy'  => array(
				'path' => 'assets/js/core/session/reopen-policy.js',
				'deps' => array( 'pufferdesk-session-store' ),
			),
			'pufferdesk-appearance'     => array(
				'path' => 'assets/js/core/appearance.js',
				'deps' => array( 'pufferdesk-config' ),
			),
			'pufferdesk-desktop-dock'   => array(
				'path' => 'assets/js/core/desktop-dock.js',
				'deps' => array( 'pufferdesk-config', 'pufferdesk-session-store' ),
			),
			'pufferdesk-wallpaper'      => array(
				'path' => 'assets/js/core/wallpaper.js',
				'deps' => array( 'pufferdesk-config' ),
			),
			'pufferdesk-menu-bar-state' => array(
				'path' => 'assets/js/core/menu-bar.js',
				'deps' => array( 'pufferdesk-config', 'pufferdesk-session-store' ),
			),
			'pufferdesk-window-factory' => array(
				'path' => 'assets/js/core/windows/window-factory.js',
				'deps' => array( 'pufferdesk-dom' ),
			),
			'pufferdesk-window-manager' => array(
				'path' => 'assets/js/core/windows/window-manager.js',
				'deps' => array( 'pufferdesk-dom', 'pufferdesk-session-store', 'pufferdesk-window-factory' ),
			),
			'pufferdesk-widget-manager' => array(
				'path' => 'assets/js/core/widgets/widget-manager.js',
				'deps' => array( 'pufferdesk-dom', 'pufferdesk-session-store' ),
			),
			'pufferdesk-desktop-icons'  => array(
				'path' => 'assets/js/core/desktop/desktop-icons.js',
				'deps' => array( 'pufferdesk-dom', 'pufferdesk-session-store' ),
			),
			'pufferdesk-folder-manager' => array(
				'path' => 'assets/js/core/desktop/folder-manager.js',
				'deps' => array( 'pufferdesk-dom', 'pufferdesk-api-client' ),
			),
			'pufferdesk-about-window'   => array(
				'path' => 'assets/js/core/apps/about-window.js',
				'deps' => array( 'pufferdesk-dom' ),
			),
			'pufferdesk-site-about-window' => array(
				'path' => 'assets/js/core/apps/site-about-window.js',
				'deps' => array( 'pufferdesk-dom' ),
			),
			'pufferdesk-app-surfaces'   => array(
				'path' => 'assets/js/core/apps/app-surfaces.js',
				'deps' => array( 'pufferdesk-dom' ),
			),
			'pufferdesk-native-apps'     => array(
				'path' => 'assets/js/core/apps/native-apps.js',
				'deps' => array(),
			),
			'pufferdesk-settings-labels' => array(
				'path' => 'assets/js/core/apps/settings/labels.js',
				'deps' => array(),
			),
			'pufferdesk-settings-ui'     => array(
				'path' => 'assets/js/core/apps/settings/ui.js',
				'deps' => array( 'pufferdesk-dom' ),
			),
			'pufferdesk-settings-panel-general' => array(
				'path' => 'assets/js/core/apps/settings/panel-general.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui' ),
			),
			'pufferdesk-settings-panel-profile' => array(
				'path' => 'assets/js/core/apps/settings/panel-profile.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui' ),
			),
			'pufferdesk-settings-panel-appearance' => array(
				'path' => 'assets/js/core/apps/settings/panel-appearance.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui' ),
			),
			'pufferdesk-settings-panel-desktop-dock' => array(
				'path' => 'assets/js/core/apps/settings/panel-desktop-dock.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui' ),
			),
			'pufferdesk-settings-panel-menu-bar' => array(
				'path' => 'assets/js/core/apps/settings/panel-menu-bar.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui' ),
			),
			'pufferdesk-settings-panel-wallpaper' => array(
				'path' => 'assets/js/core/apps/settings/panel-wallpaper.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui' ),
			),
			'pufferdesk-settings-panel-widgets' => array(
				'path' => 'assets/js/core/apps/settings/panel-widgets.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui' ),
			),
			'pufferdesk-settings-panel-apps' => array(
				'path' => 'assets/js/core/apps/settings/panel-apps.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui' ),
			),
			'pufferdesk-settings-panel-workspace' => array(
				'path' => 'assets/js/core/apps/settings/panel-workspace.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui', 'pufferdesk-session-store', 'pufferdesk-reopen-policy', 'pufferdesk-api-client' ),
			),
			'pufferdesk-settings-panel-system' => array(
				'path' => 'assets/js/core/apps/settings/panel-system.js',
				'deps' => array( 'pufferdesk-settings-labels', 'pufferdesk-settings-ui' ),
			),
			'pufferdesk-settings-app'   => array(
				'path' => 'assets/js/core/apps/settings-app.js',
				'deps' => array( 'pufferdesk-dom', 'pufferdesk-storage', 'pufferdesk-api-client', 'pufferdesk-appearance', 'pufferdesk-desktop-dock', 'pufferdesk-menu-bar-state', 'pufferdesk-wallpaper', 'pufferdesk-app-surfaces', 'pufferdesk-native-apps', 'pufferdesk-settings-labels', 'pufferdesk-settings-ui', 'pufferdesk-settings-panel-general', 'pufferdesk-settings-panel-profile', 'pufferdesk-settings-panel-appearance', 'pufferdesk-settings-panel-desktop-dock', 'pufferdesk-settings-panel-menu-bar', 'pufferdesk-settings-panel-wallpaper', 'pufferdesk-settings-panel-widgets', 'pufferdesk-settings-panel-apps', 'pufferdesk-settings-panel-workspace', 'pufferdesk-settings-panel-system' ),
			),
				'pufferdesk-app-launcher'   => array(
					'path' => 'assets/js/core/apps/app-launcher.js',
					'deps' => array( 'pufferdesk-dom', 'pufferdesk-about-window', 'pufferdesk-site-about-window', 'pufferdesk-native-apps', 'pufferdesk-settings-app' ),
				),
			'pufferdesk-search'         => array(
				'path' => 'assets/js/core/shell/search.js',
				'deps' => array( 'pufferdesk-config' ),
			),
			'pufferdesk-shell-dialogs'  => array(
				'path' => 'assets/js/core/shell/dialogs.js',
				'deps' => array( 'pufferdesk-dom' ),
			),
			'pufferdesk-menu-commands'  => array(
				'path' => 'assets/js/core/shell/commands.js',
				'deps' => array( 'pufferdesk-dom', 'pufferdesk-app-surfaces' ),
			),
			'pufferdesk-menu-schema'    => array(
				'path' => 'assets/js/core/shell/menu-schema.js',
				'deps' => array( 'pufferdesk-config' ),
			),
			'pufferdesk-menu-renderer'  => array(
				'path' => 'assets/js/core/shell/menu-renderer.js',
				'deps' => array( 'pufferdesk-dom' ),
			),
			'pufferdesk-menu'           => array(
				'path' => 'assets/js/core/shell/menu.js',
				'deps' => array( 'pufferdesk-config', 'pufferdesk-menu-commands', 'pufferdesk-menu-schema', 'pufferdesk-menu-renderer' ),
			),
			'pufferdesk-context-menu'   => array(
				'path' => 'assets/js/core/shell/context-menu.js',
				'deps' => array( 'pufferdesk-config', 'pufferdesk-menu-commands', 'pufferdesk-menu-schema', 'pufferdesk-menu-renderer' ),
			),
			'pufferdesk-shortcuts'      => array(
				'path' => 'assets/js/core/shell/shortcuts.js',
				'deps' => array( 'pufferdesk-menu-commands', 'pufferdesk-menu' ),
			),
			'pufferdesk-clock'          => array(
				'path' => 'assets/js/core/shell/clock.js',
				'deps' => array( 'pufferdesk-config' ),
			),
			'pufferdesk-boot'           => array(
				'path' => 'assets/js/core/boot.js',
				'deps' => array( 'pufferdesk-appearance', 'pufferdesk-desktop-dock', 'pufferdesk-menu-bar-state', 'pufferdesk-wallpaper', 'pufferdesk-reopen-policy', 'pufferdesk-window-manager', 'pufferdesk-widget-manager', 'pufferdesk-desktop-icons', 'pufferdesk-folder-manager', 'pufferdesk-app-launcher', 'pufferdesk-search', 'pufferdesk-shell-dialogs', 'pufferdesk-menu', 'pufferdesk-context-menu', 'pufferdesk-shortcuts', 'pufferdesk-clock' ),
			),
		);
	...
	private function get_runtime_config( $apps, $folders, $widgets, $theme, $app_locations ) {
		...
		return array(
			...
			'storageKey'   => 'pufferDesk:' . get_current_user_id() . ':' . $theme['id'] . ':session',
	...
	private function get_settings_labels_config( $theme = array() ) {
		...
		$labels = array(
			...
			'appearance'   => array(
				...
				'installedThemeHeading' => __( 'Installed Theme', 'pufferdesk-admin-desktop' ),
	...
	private function enqueue_core_styles( $include_shell ) {
		$core_styles = array(
			'pufferdesk-core-admin-chrome' => 'assets/css/core/admin-chrome.css',
		);
		...
		if ( $include_shell ) {
			$core_styles = array_merge(
				$core_styles,
				array(
					'pufferdesk-core-shell'      => 'assets/css/core/shell.css',
					'pufferdesk-core-dialogs'    => 'assets/css/core/dialogs.css',
					'pufferdesk-core-context'    => 'assets/css/core/context-menu.css',
					'pufferdesk-core-desktop'    => 'assets/css/core/desktop.css',
					'pufferdesk-core-widgets'    => 'assets/css/core/widgets.css',
					'pufferdesk-core-windows'    => 'assets/css/core/windows.css',
					'pufferdesk-core-apps'       => 'assets/css/core/apps.css',
					'pufferdesk-core-dock'       => 'assets/css/core/dock.css',
					'pufferdesk-core-responsive' => 'assets/css/core/responsive.css',
				)
			);
		}
