	...
	public function get_apps() {
		$apps = array(
			...
			array(
				...
				'label' => __( 'Pages', 'pufferdesk' ),
				'url'   => admin_url( 'edit.php?post_type=page' ),
				'icon'  => $this->theme_icon( 'pages.svg', 'dashicons-admin-page' ),
				'about' => $this->wordpress_core_about( __( 'Pages', 'pufferdesk' ) ),
				'group' => PufferDesk_App_Normalizer::GROUP_CONTENT,
				'cap'   => 'edit_pages',
			),
			array(
				...
				'about' => $this->wordpress_core_about( __( 'Media', 'pufferdesk' ) ),
				'group' => PufferDesk_App_Normalizer::GROUP_CONTENT,
				'cap'   => 'upload_files',
			),
			array(
				'id'    => PufferDesk_App_Ids::COMMENTS,
				'label' => __( 'Comments', 'pufferdesk' ),
				'url'   => admin_url( 'edit-comments.php' ),
				'icon'  => $this->theme_icon( 'comments.svg', 'dashicons-admin-comments' ),
				'about' => $this->wordpress_core_about( __( 'Comments', 'pufferdesk' ) ),
				'group' => PufferDesk_App_Normalizer::GROUP_CONTENT,
				'cap'   => 'edit_posts',
			),
			array(
				...
				'about' => $this->wordpress_core_about( __( 'Appearance', 'pufferdesk' ) ),
				'group' => PufferDesk_App_Normalizer::GROUP_SITE,
				'cap'   => 'switch_themes',
			),
			array(
				'id'    => PufferDesk_App_Ids::PLUGINS,
				'label' => __( 'Plugins', 'pufferdesk' ),
				'url'   => admin_url( 'plugins.php' ),
				'icon'  => $this->theme_icon( 'plugins.svg', 'dashicons-admin-plugins' ),
				'about' => $this->wordpress_core_about( __( 'Plugins', 'pufferdesk' ) ),
		...
		if ( PufferDesk_Admin_Screen_Availability::is_site_health_available() ) {
			$apps[] = array(
				...
				'about' => $this->wordpress_core_about( __( 'Site Health', 'pufferdesk' ) ),
				'group' => PufferDesk_App_Normalizer::GROUP_SYSTEM,
