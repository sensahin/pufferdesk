...
| Folder document | Item/document | Copy, Paste, Open, Delete selected item; Cut appears only outside PufferDesk/Finder-style menus | `assets/js/core/shell/context-menu.js`, `assets/js/core/shell/commands.js`, `assets/js/core/apps/app-launcher.js` | `document.open`, `folder.delete-selected`, clipboard commands | Uses shared menu skin | Delete/copy depends on selection state; right-click selection is local and intentional | Centralized |
