...
- Do not bundle third-party platform font files. Use system font stacks or original/licensed font assets only.
...
- Reset flows: check whether Reset Layout, Reset PufferDesk Settings, default state, reopen policy, fresh shell load, multi-browser reloads, and stale saved data need updates.
