...
$admin_os_mode_left     = isset( $admin_os_mode_position['left'] ) ? absint( $admin_os_mode_position['left'] ) : 236;
...
$admin_os_mode_time     = current_time( 'timestamp' );
?>
<section
...
>
	...
	<time class="aos-widget-clock-time" data-aos-widget-clock datetime="<?php echo esc_attr( wp_date( DATE_W3C, $admin_os_mode_time ) ); ?>">
		<?php echo esc_html( wp_date( get_option( 'time_format' ), $admin_os_mode_time ) ); ?>
	</time>
	<time class="aos-widget-clock-date" data-aos-widget-clock-date datetime="<?php echo esc_attr( wp_date( 'Y-m-d', $admin_os_mode_time ) ); ?>">
		<?php echo esc_html( wp_date( get_option( 'date_format' ), $admin_os_mode_time ) ); ?>
	</time>
</section>
