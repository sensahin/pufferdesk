...
- PufferDesk shell with system menu, site title menu, app menu bar, right-click context menus, notifications, generated and user-created desktop folders, desktop widgets, theme-driven launcher surfaces, search, draggable windows, iframe-based admin apps, and native document apps such as Sticky Notes and Text Editor.
...
- `assets/js/core/` owns reusable shell behavior through purpose-specific modules:
  ...
  - `shell/` owns global shell controls such as search, clock behavior, menu commands, top menus, and context menus. `context-menu-constants.js` exposes the PHP-provided context target/key contract to browser modules.
